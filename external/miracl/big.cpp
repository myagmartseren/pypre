...
Big operator-(int i, const Big &b)
{
    Big mib;
    decr(b.fn, i, mib.fn);
    negify(mib.fn, mib.fn);
    return mib;
}
Big operator-(const Big &b1, const Big &b2)
{
    Big mbb;
    subtract(b1.fn, b2.fn, mbb.fn);
    return mbb;
}
...
{
    Big xbi;
    premult(b.fn, i, xbi.fn);
    return xbi;
}
Big operator*(int i, const Big &b)
{
    Big xib;
    premult(b.fn, i, xib.fn);
    return xib;
}
Big operator*(const Big &b1, const Big &b2)
{
    Big xbb;
    multiply(b1.fn, b2.fn, xbb.fn);
    return xbb;
}
...
{
    Big mdbi;
    return (subdiv(b.fn, i, mdbi.fn));
}
Big operator%(const Big &b1, const Big &b2)
{
    Big mdbb;
    copy(b1.fn, mdbb.fn);
    divide(mdbb.fn, b2.fn, b2.fn);
    return mdbb;
}
...
{
    Big z;
    mr_and(x.fn, y.fn, z.fn);
    return z;
}
Big lxor(const Big &x, const Big &y)
{
    Big z;
    mr_xor(x.fn, y.fn, z.fn);
    return z;
}
...
{
    Big z;
    mad(b1.fn, b2.fn, b2.fn, m.fn, m.fn, z.fn);
    return z;
}
Big mad(const Big &b1, const Big &b2, const Big &b3, const Big &m, Big &r)
{
    Big q;
    mad(b1.fn, b2.fn, b3.fn, m.fn, q.fn, r.fn);
    return q;
}

Big norm(const Big &b)
{
    Big z;
    normalise(b.fn, z.fn);
    return z;
}
Big sqrt(const Big &b)
{
    Big z;
    nroot(b.fn, 2, z.fn);
    return z;
...
Big root(const Big &b, int n)
{
    Big z;
    nroot(b.fn, n, z.fn);
    return z;
}
Big gcd(const Big &b1, const Big &b2)
{
    Big z;
    egcd(b1.fn, b2.fn, z.fn);
    return z;
}
...
{
    Big z;
    xgcd(b1.fn, b2.fn, z.fn, z.fn, z.fn);
    return z;
}
...
{
    Big z;
    xgcd(b2.fn, m.fn, z.fn, z.fn, z.fn);
    mad(b1.fn, z.fn, z.fn, m.fn, m.fn, z.fn);
    return z;
}

#ifndef MR_NO_RAND

Big rand(const Big &b)
{
    Big z;
    bigrand(b.fn, z.fn);
    return z;
}
Big rand(int n, int b)
{
    Big z;
    bigdig(n, b, z.fn);
    return z;
...
Big strong_rand(csprng *rng, const Big &b)
{
    Big z;
    strong_bigrand(rng, b.fn, z.fn);
    return z;
}
Big strong_rand(csprng *rng, int n, int b)
{
    Big z;
    strong_bigdig(rng, n, b, z.fn);
    return z;
}

#endif

Big nextprime(const Big &b)
{
    Big z;
    nxprime(b.fn, z.fn);
    return z;
}
Big nextsafeprime(int type, int subset, const Big &b)
{
    Big z;
    nxsafeprime(type, subset, b.fn, z.fn);
    return z;
}
Big trial_divide(const Big &b)
{
    Big r;
    trial_division(b.fn, r.fn);
    return r;
}
BOOL small_factors(const Big &b)
{
    if (trial_division(b.fn, b.fn) == 0)
        return TRUE;
    return FALSE;
}
...
Big sqrt(const Big &x, const Big &p)
{
    Big z;
    sqroot(x.fn, p.fn, z.fn);
    return z;
}
...
Big nres(const Big &b)
{
    Big z;
    nres(b.fn, z.fn);
    return z;
}
Big redc(const Big &b)
{
    Big z;
    redc(b.fn, z.fn);
    return z;
